...
export function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col bg-sidebar text-white transition-transform duration-200 ease-in-out",
          "md:static md:z-auto md:w-60 md:translate-x-0 md:flex md:min-h-screen",
